...
public class ColorCheckYellow : MonoBehaviour
{       
   public ColorCheckGreen colorCheckGreen;
   public GameObject ResetRestart;
   public GameObject fakeBallYellow;
    ...
    {
     if(col.gameObject.tag == "Yellow Ball")
     {
         ...
         Instantiate(fakeBallYellow, FakeBallPostition, FakeBallRotation, FakeBallsClones);
         fakeBallYellow.SetActive(true);
